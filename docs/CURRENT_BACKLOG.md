...
| 事项 | 状态 | 完成边界 | 关联文档 |
| --- | --- | --- | --- |
| 真实可见窗口完整任务验收 | 待验收 | 人工选择片源、提交、观察运行、完成或取消、打开并审看结果 | [`FRONTEND_DELIVERY_GOALS.md`](FRONTEND/current/FRONTEND_DELIVERY_GOALS.md) |
...
| 已安装路径通知行为 | 待验收 | 通知中心归属正确，点击通知能够聚焦应用 | [`FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md`](FRONTEND/current/FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md) |
...
| 事项 | 状态 | 完成边界 | 关联文档 |
| --- | --- | --- | --- |
| 失败恢复矩阵 | 待实现 | 配置、凭据、识别、目录和任务失败都有真实可执行的恢复动作 | [`FRONTEND_DELIVERY_GOALS.md`](FRONTEND/current/FRONTEND_DELIVERY_GOALS.md) |
| 完整任务恢复与结果处理 | 待实现 | 补齐历史恢复矩阵、跨任务筛查、完整结果编辑和高级导出复核 | [`FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md`](FRONTEND/current/FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md) |
| 术语能力归位 | 待决策 | 区分生成术语建议、使用术语和维护术语，并明确回流与优先级语义 | [`FRONTEND_DELIVERY_GOALS.md`](FRONTEND/current/FRONTEND_DELIVERY_GOALS.md) |
| 高级翻译与识别设置 | 待实现 | 补齐 fallback routing、mapping、识别高级参数和诊断修复联动 | [`FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md`](FRONTEND/current/FLUTTER_FRONTEND_IMPLEMENTATION_CHECKLIST.md) |
