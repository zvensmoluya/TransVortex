...
def agent_info_payload() -> dict:
    return {
        ...
        "setup_contract": {
            ...
            "schema_version": 1,
            "kinds": ["setup_plan", "setup_verify", "provider_test", "agent_plan", "agent_result"],
            "read_only_commands": [
        ...
        "recommended_workflow": [
            ...
            "if active ASR is local_server or remote: request route-specific authorization and run the advertised asr provider-test command",
            "transvortex asr setup-verify --json --strict",
        ...
        "commands": {
            ...
            "asr setup-plan": {
                ...
                "purpose": "Describe the pinned, user-scoped ASR setup contract without installing anything",
