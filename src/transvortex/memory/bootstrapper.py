...
def _bootstrap_prompt(config: AppConfig, segments: list[Segment], source_lang: str, target_lang: str) -> str:
    ...
    return (
        ...
        + "\n".join(_numbered_source_lines(segments))
    ...
    for attempt, route in enumerate(route_candidates, start=1):
        ...
        try:
            ...
            req = NormalizedRequest(
                ...
                context_before=[],
                context_after=[],
                style_prompt=_bootstrap_prompt(config, segments, source_lang, target_lang),
