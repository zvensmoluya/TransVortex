...
def doctor_report(*, root_dir: Path, providers_file: Path | None = None) -> dict[str, Any]:
    ...
    if asr_provider is not None and asr_provider.kind == "local_inprocess":
        ...
        hint_by_code = {
            ...
            "model_path_missing": "请选择已有的 faster-whisper 模型目录。",
            "model_path_unavailable": "已有模型目录不可用，请重新选择。",
            "model_unverified": "请在语音识别设置中验证已有模型。",
            "model_changed": "已有模型文件发生变化，请重新验证。",
            "model_mismatch": "已有模型规格与保存设置不一致，请重新验证。",
