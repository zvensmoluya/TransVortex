...
> **文档状态：持续演进的设计说明。** 本文保留部分早期路线背景，不单独承担当前施工计划。当前文档导航见 [`docs/README.md`](docs/README.md)，短期待办见 [`docs/CURRENT_BACKLOG.md`](docs/CURRENT_BACKLOG.md)；Flutter、Local Service、固定 runtime 和 NSIS 安装器的现状以对应专题文档为准。
