export const zh = {
  ...
  outputFormat: "输出格式",
  bilingual: "双语字幕",
  subtitleBilingualOrder: "双语顺序",
  subtitleTargetSource: "译文在上，原文在下",
  subtitleSourceTarget: "原文在上，译文在下",
  subtitlePreferSingleLine: "尽量保持单行",
  ...
  memoryPreset: "项目术语表",
  memoryPresetHint: "填写 memory/presets 下的 preset id，多个用逗号分隔；可用 nold:locked 覆盖状态。启用翻译注入后会参与当前任务。",
  chunkSec: "ASR 窗口秒数",
  overlapSec: "ASR 重叠秒数",
  sourceMode: "字幕来源",
  subtitleTrack: "内置字幕轨",
