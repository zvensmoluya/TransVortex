...
$report = [ordered]@{
    ...
    completion_claim = "Manual visible release evidence only; combine with current automated smoke, external-service, notification, AppUserModelID, and native-installer evidence before claiming the frontend design MVP is complete."
